...
// Import the canvas editor lib and make it available
// import * as Editor from 'fabricjs-label-editor'
// window.LabelEditor = Editor;
(window as any).EditorApp = new Editor.ImageEditor(document.getElementById('image-editor-container')!);
